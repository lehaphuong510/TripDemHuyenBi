...
<style>
    ...
    .slot-card { border-radius: 8px; box-shadow: 0 4px 6px rgba(0,0,0,0.1); margin-bottom: 15px; overflow: hidden; }
    .slot-header {
    ...
    .slot-body {
        background-color: #f9fbf9; text-align: center; padding: 15px; border: 1px solid #198754;
        border-top: none; border-radius: 0 0 8px 8px; font-size: 1.1rem; color: #333;
    }
    .slot-highlight { color: #D4AF37; font-size: 2rem; font-weight: 900; margin: 0 8px; text-shadow: 1px 1px 2px rgba(0,0,0,0.1); }
    ...
    .stButton>button {
        background: linear-gradient(135deg, #D4AF37 0%, #AA771C 100%); color: white; text-transform: uppercase;
        font-weight: bold; border: none; width: 100%; border-radius: 8px; padding: 12px; margin-top: 20px;
    }
    .stButton>button:hover { background: linear-gradient(135deg, #198754 0%, #0F5132 100%); color: white; box-shadow: 0 4px 10px rgba(0,0,0,0.2); }
</style>
